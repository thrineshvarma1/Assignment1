       ...
       */
        ...
        */
        ...
        private static int DiagonalSum(int[,] bulls_grid)
        {
            ...
            {
                // write your code here.
                int Len = bulls_grid.Length;
                int n = Convert.ToInt32(Math.Sqrt(Len));
                int temp = 0;
                for (int j = 0; j < n; j++)
                {
                    temp = temp + bulls_grid[j, j] + bulls_grid[j, n - j - 1];
                }
                if (n % 2 != 0)
                {
                    return temp - bulls_grid[(n - 1) / 2, (n - 1) / 2];
                }
                else
                {
                    return temp;
        ...
        */
        ...
        private static string RestoreString(string bulls_string, int[] indices)
        {
            try
            {
                ...
                {
                    int b = indices[i];
                    arr[b] = Convert.ToString(bulls_string[i]);
                }
                for (int i = 0; i < bulls_string.Length; i++)
                {
                    Temp = Temp + arr[i];
        ...
        private static string ReversePrefix(string bulls_string6, char ch)
        {
            try
            {
                ...
                for (int i = 0; i < bulls_string6.Length; i++)
                {
                    ...
                    {
                        temp = bulls_string6.Split(ch);
                    }
                }
                string temp2 = "";
                for (int j = temp[0].Length - 1; j >= 0; j--)
                {
                    temp2 = temp2 + bulls_string6[j];
                }
                prefix_string = ch + temp2 + temp[1];
